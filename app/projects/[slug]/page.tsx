...
export default async function ProjectPage({ params }: ProjectPageProps) {
  ...
  return (
    <main className="min-h-screen overflow-hidden bg-bg">
      <header className="relative isolate px-5 pb-6 pt-20 sm:px-8 lg:px-12 lg:pt-24">
        ...
        <div className="mx-auto max-w-7xl">
          ...
          <div className="mt-5 grid items-end gap-5 lg:grid-cols-[1.1fr_0.9fr]">
            <h1 className="max-w-5xl text-hero font-semibold text-foreground">{meta.title}</h1>
            <p className="max-w-2xl text-sm leading-7 text-neutral-400">{meta.summary}</p>
          </div>

          <div className="mt-7 grid overflow-hidden rounded-xl border border-neutral-800 bg-neutral-900/55 backdrop-blur-xl md:grid-cols-2">
            ...
            <div className="border-t border-neutral-800 p-4 sm:p-5 md:border-l md:border-t-0">
              <p className="font-mono text-[9px] uppercase tracking-[0.2em] text-neutral-500">
                Engineered outcome
              </p>
              <p className="mt-2 text-xs leading-5 text-neutral-300">{showcase.outcome}</p>
            </div>
            <div className="border-t border-neutral-800 px-4 py-3 sm:px-5 md:col-span-2">
