...
export const PROJECT_B2_VIDEOS: Record<string, ProjectB2VideoEntry> = {
  ...
  wonder_feed: [
    `${B2_PUBLIC_BASE}/lofi_reel_grief_learning_to_carry_it_20260912_055532_v01.mp4`,
    `${B2_PUBLIC_BASE}/lofi_reel_distance_silence_that_speaks_20260912_053648_v01.mp4`,
    `${B2_PUBLIC_BASE}/lofi_reel_grief_learning_to_carry_it_20260912_051957_v01.mp4`,
    `${B2_PUBLIC_BASE}/lofi_reel_distance_silence_that_speaks_20260912_050447_v01.mp4`,
    `${B2_PUBLIC_BASE}/lofi_reel_perseverance_getting_up_anyway_20260912_044140_v01.mp4`,
    `${B2_PUBLIC_BASE}/lofi_reel_grief_learning_to_carry_it_20260912_041125_v01.mp4`,
  ],
  momma_circle: [
    `${B2_PUBLIC_BASE}/lofi_reel_self_compassion_good_enough_mother_20260912_060212_v01.mp4`,
    ...
    `${B2_PUBLIC_BASE}/lofi_reel_self_compassion_good_enough_mother_20260912_051136_v01.mp4`,
    `${B2_PUBLIC_BASE}/lofi_reel_presence_phones_down_eye_contact_20260912_045351_v01.mp4`,
    `${B2_PUBLIC_BASE}/lofi_reel_sleep_routines_as_safety_20260912_042524_v01.mp4`,
  ],
