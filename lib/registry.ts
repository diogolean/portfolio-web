...
export const PROJECT_B2_VIDEOS: Record<string, ProjectB2VideoEntry> = {
  ...
  momma_circle: [
    `${B2_PUBLIC_BASE}/lofi_reel_presence_phones_down_eye_contact_20260912_165636_v01.mp4`,
    `${B2_PUBLIC_BASE}/lofi_reel_sleep_routines_as_safety_20260912_163635_v01.mp4`,
    `${B2_PUBLIC_BASE}/lofi_reel_self_compassion_good_enough_mother_20260912_141507_v01.mp4`,
